...
{
    public partial class boksYeniüye : Form
    {
        public boksYeniüye()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(connString))
            {
                ...
                {
                    con.Open();
                    string query = "INSERT INTO newBoxingMember(Fname, Lname, Gender, Dob, Mobile, Email, JoinDate, GymTime, Maddress, MembershipTime) " +
